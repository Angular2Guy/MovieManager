 ...
 */
package ch.xxx.moviemanager.architecture;
...
import ch.xxx.moviemanager.architecture.MyArchitectureTests.DoNotIncludeAotGenerated;
import net.javacrumbs.shedlock.spring.annotation.SchedulerLock;

@AnalyzeClasses(packages = "ch.xxx.moviemanager", importOptions = { DoNotIncludeTests.class, DoNotIncludeAotGenerated.class })
public class MyArchitectureTests {
	...
	private JavaClasses importedClasses = new ClassFileImporter()
			...
			.importPackages("ch.xxx.moviemanager");
